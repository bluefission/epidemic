...
@section('content')
            ...
            <div class="content-wrap">
                <div class="container clearfix">
					...
					Our mission is to confront existential threat by providing tools and data that allow the community to track and understand new and existing epidemic events. That mission exends from our Platform, Organization, Community and Services (which we collectively refer to in this Privacy Policy as the “Services”). Our Privacy Policy describes how we collect and process your Personal Data through our websites (e.g., including, but not limited to, our Website and corresponding Mobile App. We encourage you to read this Privacy Policy as well as our Terms and Conditions of Use (referred to throughout as our “Terms”). 

					<strong>By using the services, you consent to the collection, use, and tranfer of your personal data for processing in the United States as described in this privacy policy. If you are an end users from outside the US, please note that </strong> our Organization and associated Services and Platform, including registration, is housed on servers in the United States. If you are located outside of the United States, please be aware that information we collect (including cookies and device data) will be processed and stored in the United States, a jurisdiction in which the data protection and privacy laws and principles, including your data subject rights, may not offer the same level of protection as those in the country/region where you reside or are a citizen. By using our Services and providing information to us, you consent to the transfer to and processing of the information in the United States and, unless otherwise stated in this Privacy Policy, we use this consent as the legal ground for that data transfer. When collecting your Personal Data on our Fitness and Wellness services, you may be asked for your explicit consent to this data transfer as part of account creation.
					...
					Who We Are
					&laquo; &laquo; To Add Later &raquo; &raquo;
					...
					We collect, use, disclose and process Personal Data as outlined in this Privacy Policy, including to operate and improve the Services and our business and to provide you with innovative fitness and wellness services, as further described in this Privacy Policy.
					...
					When you input Fitness and Wellness Data within our Services or use our Services that collect or infer such data from mobile device sensors. 
						...
						"Fitness and Wellness Data" includes data you provide related to your lifestyle (e.g., sleeping habits), life events, dietary restrictions, height, weight, measurements, fitness level, heart rate, sleep data, BMI, biometric data, and similar types of data relating to physiological condition, and activity. We collect this data in order to provide the Services, to offer relevant suggestions and alerts regarding protecting yourself and others from illness, and to provide anonymized epidemiological survey data to track to movement, nature, and spread of illness and outbreaks.

					When you give us permission to collect Location Data. 

						We may collect precise Location Data as part of the functionality of our Services, such as to provide geographically relevant Services and to conduct analytics to improve the Services. We may collect precise Location Data in several ways, such as through your wireless carrier, based on WiFi access point location, via Bluetooth beacons, through a connected device, or directly from the device on which you use the Services. If you are accessing the Services through one of our mobile applications, the way we collect precise Location Data will differ depending on your mobile device's operating system. In all events, we do not collect precise Location Data, unless you have "allowed" its collection. If you decline to allow Location Data collection in the app, we will not collect your precise Location Data unless you manually enter it in.

					When you communicate with us or sign up for informational materials. 

						We collect Personal Data when you communicate with us or sign up to receive information via email, push notifications, or text messages - including email address, mobile number, WeChat ID, etc.

						If you consent to such messages, we may use your Personal Data and other information to communicate with you about events or Services you have requested updates for, or to request information for a study or to improve our Services. You can manage your communication preferences by registering for and logging into your account.
						...
						We may use your Personal Data to respond to your requests for technical support, online services, or to any other communication you initiate. This includes accessing your account to address technical support requests. We may also use your Personal Data to address your requests, inquiries, and complaints.
					...
					When we leverage and/or collect cookies, device IDs, Location, data from the environment, and other tracking technologies. 
						...
						We may collect certain Personal Data using cookies and other technologies such as web beacons, device IDs, geolocation, HTML5 local storage, Flash cookies, and IP addresses. We specifically use browser cookies for different purposes, including cookies that are strictly necessary for functionality and cookies that are used for personalization and performance/analytics. Our Cookie and Device ID Use section contains more information and options to control or opt-out of certain data collection or uses.
					...
					When you take fitness tests or assessments or invite friends. 

						We use submitted and collected data to provide instructional feedback. With your permission, we access your contacts and calendar to invite friends to use the Services.

					When we provide you geographically relevant Services, offers, or advertising. 

						Where you have provided consent to process your precise Location Data, we may use such data to provide you with Services, inforamtion, and updates that are relevant to your location.

					When we comply with Legal Requirements or Obligations, Law Enforcement, and for Public Safety Purposes ( Location-Specific Disclosures may apply). 
					...
					-"Activity Stats" are set as Share with Friends. "Share for Research" means visible to your friends, but not shared with other members. You can change this default status if you want. Information that is set as "Share for Research" by default includes, for example, symptoms and locations.
					-Lookup Information is set as Public. We believe that social motivation helps encourage participcation in citizen science allowing your friends to be able to find you is crucial to this experience. Therefore, your first and last name, location, gender, username, main fitness activity, and profile picture are set as Public. If you set your entire account as Private, your lookup data will no longer be available for your friends to find you (unless you otherwise indicate that desire within the Services).
					
					<h3>Changing Your Sharing Preferences</h3>
					...
					<h2>Managing Preferences and Withdrawing Consent</h2>
					...
					Cookie Use and Controls 
						Cookies serve a wide variety of purposes. Cookies are pieces of data stored in your web browser that are transmitted to websites to remember your browser over time and distinguish it from other users. Cookies are used to personalize your web experience, for security, and analytics. Our cookies are placed and read by our web servers. You can block and control cookies using the information noted in this section. If you block all cookies, certain functionality on our website will not work.
					...
					IP Address Use 
						An IP address refers to an identifier assigned by a network to a computer, mobile device, Internet of Things (IoT) device, or routing device. IP addresses, for purposes of this Privacy Policy, include "public" IP addresses, such as the IP address for a home router that is visible to the Internet, as well as "local" IP addresses, which are IP addresses assigned to computers and mobile devices "behind" a router (such as a home router). We may use IP addresses for security purposes and verification of legitmate activity.

						You can choose not to have IP address used for purposes of analytics by using the cookie controls for "Performance/Analytics," above.
					...
					Mobile Device Advertising IDs, Location, Sensor Data, and In-Range Device Data Use 
						Our mobile apps and our Services may transmit Device IDs, Location Data, and data from sensors to us and our partners.
						...
						How We Use Mobile Device Data. We may use Device IDs, coarse location and Location Data, and data from sensors, including the local network, (together with app usage data and Fitness and Wellness Data) for strictly necessary purposes; improving our apps and analytics; and personalization and preferences.

					Withdraw Your Consent for Use of Your Mobile Device IDs and Location Data for Analytics
					...
					Change Consent Settings for Communication Preferences 
						Consent for Email Communication: After signing up for email communications, you can choose to unsubscribe using the unsubscribe link in any email we send. If you use more than one Service, then unsubscribing from the emails relating to that Service will not stop you from receiving emails from other Services. Please note that if you unsubscribe from "all emails" this means "all emails other than strictly necessary emails." You will still receive email communications from us if they are strictly necessary to provide the service or to confirm or validate a transaction, recover accounts, etc.
						
						Opt-In Mobile Text Messages: You can opt-in to receive notification text messages. Text messages are auto-dialed and consent to text messages is not required for any purchase or service. You can opt-out of marketing by sending STOP to the number following the directions sent back to you when you sign up.

						Mobile Push Notifications: You can manage the type of push notifications you receive from us by modifying the settings within the Service. For more information on how to update your push notification settings for our Services please visit here. You may also set your mobile device settings to not allow push notifications from us.

					<h2>Transfers of Your Personal Data to Other Countries</h2>
