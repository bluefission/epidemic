...
@section('content')
            ...
            <div class="content-wrap">
                <div class="container clearfix">
                    ...
                    <h1>Terms Service</h1>
                    Effective Date: March 7th, 2020

					We are passionate about creating innovative products and services to empower democratized participation in science and medicine, and we appreciate your involvement. These Terms and Conditions of Use are the rules of the game - designed to create a positive, law-abiding community of our users. By using our products and services, you are agreeing to all the terms below.

					We, as well as our affiliates, including Blue Fission. and Eidolon Institute (collectively referred to throughout as “we” or “us”), offer a variety of products and services (collectively, the “Services”).

					THESE TERMS INCLUDE A BINDING ARBITRATION CLAUSE AND A CLASS ACTION WAIVER IN SECTION 15. THIS PROVISION AFFECTS YOUR RIGHTS TO RESOLVE DISPUTES WITH US AND YOU SHOULD REVIEW IT CAREFULLY. YOUR CHOICE TO MAINTAIN AN ACCOUNT, ACCESS OR USE THE SERVICES (REGARDLESS OF WHETHER YOU CREATE AN ACCOUNT WITH US) CONSTITUTES YOUR AGREEMENT TO THESE TERMS AND OUR PRIVACY POLICY, WHICH IS INCORPORATED INTO THE TERMS. IF YOU DISAGREE WITH ANY PART OF THE TERMS, THEN YOU ARE NOT PERMITTED TO USE OUR SERVICES.

					Please note that by accessing or using our Services, your Personal Data (as that term is defined in the Privacy Policy) will be used accordingly.
					...
					You must be at least 18 to use our services (unless otherwise specified in the International Terms section applicable to specific jurisdictions). If you are between the ages of 13-18, you may use our Services only with the supervision and consent of a parent or guardian. No individual under these age limits may use the Services, provide any Personal Data to Under Armour, or otherwise submit Personal Data through the Services (e.g., a name, address, telephone number, or email address).

					Your Account
					You may need to create an account to access the Services, and it's important that the information associated with your account is accurate and up-to-date (particularly your email address - if you ever forget your password, a working email address is often the only way for us to verify your identity and help you log back in).

					You may need to register for an account to access or use certain Services. Your account may also automatically provide you access and means to use any new Services.
					...
					Definitions
					Content is what shows up on your display when you use our Services. User-Generated Contentis any Content (Data)  that is created by you or other users, and UA Content is all other Content.
					
					For purposes of these Terms, (i) “Content” means any form of information, data or creative expression and includes, without limitation, video, audio, photographs, images, illustrations, animations, tools, text, ideas, communications, replies, “likes,” comments, software, scripts, executable files, graphics, maps, routes, geo-data, workouts and workout data, biometric data and data elements derived therefrom, training plans, sleep activity, annotations, nutrition information, recipes, interactive features, designs, copyrights, trademarks, service marks, branding, logos, and other similar assets, patents, sounds, applications and any intellectual property therein, any of which may be generated, provided, or otherwise made accessible on or through the Services; (ii) “User-Generated Content” means any Content that a user submits, transfers, or otherwise provides to or through the use of the Services; and (iii) “UA Content” means all Content that is not User-Generated Content.

					Ownership
					You own the Content that you create, and we own the Content that we create.

					All UA Content and all copyright, trademarks, design rights, patents and other intellectual property rights (registered and unregistered) in and on the Services belong to us and/or its partners or applicable third parties. Each user retains ownership, responsibility for, and/or other applicable rights in the User-Generated Content that he/she creates, but grants a license of that User Generated Content to us as explained in Section ?.? below. We and/or its partners or third parties retain ownership, responsibility for and/or other applicable rights in all UA Content. Except as expressly provided in the Terms, nothing grants you a right or license to use any UA Content, including any content owned or controlled by any of our partners or other third parties. You agree not to duplicate, publish, display, distribute, modify, or create derivative works from the material presented through the Services unless specifically authorized in writing by us.

					Our License to You
					You are welcome to access and use the UA Content and Services. We work hard to provide a great experience for our users, so please respect our intellectual property rights and only use the UA Content and Services as intended. This includes not using any UA Content or Services for commercial purposes without our permission. We do have APIs and other tools you can use to help create your own apps and products. Contact us to find out more.

					Subject to your compliance with these Terms, we grant you a limited, revocable, personal, non-transferable, and non-exclusive right and license to access and use the Services and UA Content for your own personal, noncommercial purposes, provided that you do not (and do not allow any third party to) copy, modify, create a derivative work from, reverse engineer, sell, assign, sublicense, grant a security interest in, transfer or otherwise commercially exploit any right in the UA Content or Services.

					Acceptable Usage Guidelines
					UA Content. Except as expressly permitted by applicable law or authorized by Under Armour, you agree not to modify, rent, lease, loan, sell, distribute, or create derivative works based on the Services, the Services’ software, or any UA Content offered as part of the Services (other than User-Generated Content), in whole or in part. You shall not download, copy, or save UA Content, except (i) as expressly permitted by the functionality of certain Services (e.g., printed maps) as provided for in the specific guidelines and/or additional terms applicable to those Services, or (ii) solely for personal use or your records.

					Commercial Usage of the Services. The Services, with the exception of certain products and services provided though the Under Armour-branded websites and certain widgets we make available as tools for website owners (collectively, the “Commercial Tools”), are intended only for your personal, non-commercial use. You shall not use the Services (other than certain Commercial Tools) to sell a product or service, increase traffic to your own website or a third-party website for commercial reasons (such as advertising sales), or otherwise undertake any endeavor aimed at deriving revenue. For example, you shall not take the results from a search of the Services and reformat and display them, or mirror our home pages or results pages on your website. Moreover, you shall not “meta-search” our Services. If you seek to make commercial use of the Services other than through the Commercial Tools, you must enter into an agreement with us to do so in advance. To learn more about the Commercial Tools, please visit our Developer Portal. By using any of the Commercial Tools, you acknowledge and agree to the Terms and any additional terms and conditions applicable to those select Services.

					Linking to the Services. If you would like to link to our Services on your website or application, please follow these rules: (i) any link to the Services must be a text only link clearly marked “Under Armour” (without the use of any other trademark, logo copyright or any other intellectual property asset owned or controlled by Under Armour) or in some other format directed by Under Armour, (ii) the appearance, position and other aspects of the link may not damage or dilute the goodwill associated with our marks, (iii) the link must “point” to the root domain name of the Services and not to other pages within the Services, (iv) the appearance, position and other attributes of the link may not create the false appearance that your organization or entity is sponsored by, affiliated with, or associated with Under Armour, (v) when selected, the link must display the Service on full-screen and not within a “frame” on the linking website or service, and (vi) Under Armour reserves the right to revoke its consent to the link at any time and in its sole discretion, and upon our notification to you of such revocation of consent, you agree to promptly remove the relevant link.
					...
					You agree you will respect the intellectual property rights of others. You represent and warrant you have all the necessary rights to grant Under Armour the foregoing license for all User-Generated Content you submit in connection with the Services and will indemnify us for any breach of this representation and warranty.
					...
					Other. Don’t post Content that contains anything that, in Under Armour’s sole determination, is objectionable or inhibits any other person from using or enjoying the Services, or that may expose Under Armour or our users to any harm or liability of any kind. Don’t post content that may damage or dilute the goodwill associated with Under Armour or our marks.
					...
					Reporting Objectionable User-Generated Content
					...
					We respect intellectual property laws. If anything is wrong, please send an email with all the details to ConnectedFitnessIP@ua.com
					...
					Third-Party Services, Activities, and Events
					Our Services may include the ability to discover, access or participate in certain services, activities, or events (“Third-Party Activities”). By way of example and not limitation, you can use the Under Armour We Will site to access information about and register for third party volunteer opportunities. Third-Party Activities are offered and provided by Third Parties, not Under Armour. Your attendance at and participation in Third-Party Activities is solely at your own risk. Under Armour will not be liable for any act, error or omission of any Third Party, including, without limitation, any which arises out of or is any way connected with a user’s attendance, use of or participation in any Third-Party Activities initially discovered, booked or registered for via the Services, or the performance or non-performance of any Third Party in connection with the Services. Under Armour is not an agent of any provider of Third-Party Activities.
					...
					The Terms are an agreement between us, and not with the App Provider. As between us and the App Provider, Under Armour is solely responsible for its applications;
					The App Provider has no obligation to provide any maintenance and support services with respect to the Under Armour applications;

					In the event of any failure of the applications to conform to any applicable warranty, (i) you may notify the App Provider and the App Provider may refund the purchase price for the applications to you (if applicable), (ii) to the maximum extent permitted by applicable law, the App Provider will have no other warranty obligation whatsoever with respect to the applications, and (iii) any other claims, losses, liabilities, damages, costs or expenses attributable to any failure to conform to any warranty will be, as between Under Armour and the App Provider, Under Armour’s responsibility;
					...
					If a third party claims an application infringes another party’s intellectual property rights, as between the App Provider and ourselves, we will be responsible for the investigation, defense, settlement and discharge of any such claim to the extent required by these Terms;
					...
					To the maximum extent permitted by applicable law, you and Under Armour agree that any dispute resolution proceedings will be conducted only on an individual basis and not in a class, consolidated or representative action. Except where prohibited, you and we agree to submit to the personal and exclusive arbitration of disputes relating to your general use of the Services under the rules of the American Arbitration Association. Please visit www.adr.org for more information about arbitration.
					...
					This agreement to arbitrate will not preclude you or Under Armour from seeking provisional remedies in aid of arbitration, including without limitation orders to stay a court action, compel arbitration or confirm an arbitral award, from a court of competent jurisdiction. Furthermore, this agreement to arbitrate will not preclude you or Under Armour from (i) applying to the appropriate court of competent jurisdiction for a temporary restraining order, preliminary injunction, or other interim or conservatory relief, as necessary, or (ii) seeking relief in any state or federal court for disputes related to a violation or possible violation of Under Armour’s intellectual property rights.
					...
					If you are a resident of the European Union: Notwithstanding anything in these Terms to the contrary, if there is a dispute that you and Under Armour cannot resolve, you have the right to submit a complaint through http://ec.europa.eu/consumers/odr. Other than as set out in these Terms, we do not participate in any ADR scheme.

					In addition, nothing in these Terms limits your rights to bring an action against Under Armour in the local courts of your place of domicile. All disputes arising under the Terms between you and Under Armour will be subject to the non-exclusive jurisdiction of the courts located in your place of domicile, or the courts located in the Netherlands, and you and we hereby submit to the personal jurisdiction and venue of these courts.
					If you are a resident of Finland: Notwithstanding anything in these Terms to the contrary, if there is a dispute that you and Under Armour cannot resolve, you have the right to submit a complaint to the local Consumer Disputes Board or other corresponding body.

					If you are a resident of Denmark: Notwithstanding anything in these Terms to the contrary, if there is a dispute that you and Under Armour cannot resolve, you have the right to submit a complaint to the Danish Competition and Consumer Authority (Konkurrence- og Forbrugerstyrelsen, Center for Klageløsning, Carl Jacobsens Vej 35, 2500 Valby, mail: cfk@kfst.dk).

					If you are a resident of South Korea: Notwithstanding anything in these Terms to the contrary, nothing in these Terms limits your rights to bring an action against Under Armour in the local courts of your place of domicile.
